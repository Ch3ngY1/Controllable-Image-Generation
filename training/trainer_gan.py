...
class DefaultTrainer(object):
    ...
    def __init__(self, args):
        ...
        self.model = getattr(models, args.model_name.lower())()
    ...
    def validation(self, step, val_iter, val_epoch_size):
        ...
        with torch.no_grad():
            for i in range(val_epoch_size):
                ...
                # logit, emb, log_var, loss = self.model(img, img2, target, target2, mh, mh2)
                score, loss_tmp = self.model(img, img2, target, target2)
        ...
        # mae, acc = self.metric(total_score, total_target, self.poe)
